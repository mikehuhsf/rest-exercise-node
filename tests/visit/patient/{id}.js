...
/**
 * Test for /visit/patient/{id}
 */
Test('/visit/patient/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 405
         */
        t.test('test getPatientVisits get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/visit/patient/{id}']['get']['responses']['200']['schema']);
