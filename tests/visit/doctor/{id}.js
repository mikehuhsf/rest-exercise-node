...
/**
 * Test for /visit/doctor/{id}
 */
Test('/visit/doctor/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 405
         */
        t.test('test getDoctorVisits get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/visit/doctor/{id}']['get']['responses']['200']['schema']);
